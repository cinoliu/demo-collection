...
.main .total .sphere .sphere-bg {
  ...
  width: 100%;
  height: 100%;
  background: url(../../assets/img/surround/earth.png) no-repeat center;
...
.main .total .sphere .sum {
  ...
  width: 100%;
  height: 100%;
  background: url(../../assets/img/surround/cloud.png) no-repeat center;
  background-size: 55%;
}
...
.main .total .cicle3 {
  width: 35rem;
  height: 35rem;
  background: url(../../assets/img/surround/circle.png) no-repeat center;
  background-size: 100%;
  position: absolute;
  top: 20%;
  left: 50%;
...
.main .total .cicle4 {
  ...
  left: 50%;
  transform-style: preserve-3d;
  background: url(../../assets/img/surround/gqright.png) no-repeat center;
  background-size: 100%;
  transform: translateX(-50%) rotateX(75deg);
...
.main .total .cicle5 {
  ...
  left: 50%;
  transform-style: preserve-3d;
  background: url(../../assets/img/surround/gqleft.png) no-repeat center;
  background-size: 100%;
  transform: translateX(-50%) rotateX(75deg);
...
.main .total .cicle6 {
  ...
  left: 50%;
  transform-style: preserve-3d;
  background: url(../../assets/img/surround/gqbottomright.png) no-repeat center;
  background-size: 100%;
  transform: translateX(-50%) rotateX(75deg);
  animation: rotate3 2s linear infinite;
}
...
.main .total .cicle7 {
  ...
  left: 50%;
  transform-style: preserve-3d;
  background: url(../../assets/img/surround/gqbottomleft.png) no-repeat center;
  background-size: 100%;
  transform: translateX(-50%) rotateX(75deg);
  animation: rotate4 2s linear infinite;
}
...
.main .total .cicle8 {
  background: url(../../assets/img/surround/circle1.png) no-repeat;
  background-size: 100%;
...
.main .total .cicle9 {
  background: url(../../assets/img/surround/circle2.png) no-repeat;
  background-size: 100%;
