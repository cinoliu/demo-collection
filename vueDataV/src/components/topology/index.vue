...
<template>
  <div class="wrap-container sn-container">
    <div class="sn-content">
      <div class="sn-title">椭圆节点拓扑</div>
     


  <div class="sn-body">
        <div class="wrap-container">
          <div id="topologyID" style="width:1000px;height:800px;"></div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    getEchart() {
        ...
        var myChart = echarts.init(document.getElementById('topologyID'));
      var getY = function(x) {
